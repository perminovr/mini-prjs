$(PRE_CPPSO_MkFiles):
	...
	@echo "" >>$@
	@echo "" >>$@
	@echo "SODOBJ_$(notdir $(@D)) := \$$(patsubst %.cpp,%.d,\$$(addprefix \$$(sort \$$(addsuffix /Build/$(notdir $(@D))/,\$$(patsubst %/$(notdir $(@D))/src/,%,\$$(dir \$$(SRC_$(notdir $(@D))))))),\$$(notdir \$$(SRC_$(notdir $(@D))))))" >>$@
	...
	@echo -e "\t@\$$(CXX) \$$(LDFLAGS) \$$(LDFLAGS_$(notdir $(@D))) -L\$$(BUILD_LIB) -shared -fPIC -Wl,-soname,lib$(notdir $(@D)).so -o \$$@ \$$(SOOBJ_$(notdir $(@D))) \$$(PREBUILDLIB_$(notdir $(@D))) \$$(LDLIBS_$(notdir $(@D))) 2>>\$$(BUILD_LOG)/err-$(notdir $(@D))-\$$(TM).log" >>$@
	@echo "" >>$@
